...
public class PokerProjectFinalVersionSemester1
{
  ...
  public static void main(String[] args)
  {
	...
	String pattern1 = "0|1", pattern2 = "y|Y|n|N", pattern3 = "n|N";
    ...
    do
    {
      ...
      if (choice == 1)
      {
        ...
        do
        {
		   ...
		   if (playAgain == null)  
		      endGame = 1; //equivalent to ending
           else if (!(playAgain.matches(pattern2)))
             JOptionPane.showMessageDialog(null, errorMessage1);
           else if (playAgain.matches(pattern3))
			 endGame = 1; // if user input is n or N end game
		   else 
			 endGame = 2; // user input must be y or Y 
        } while (endGame != 1 && endGame != 2); // end (inner) do...while
      } 
      else 
        endGame = 1;
    } while (endGame == 2); // end (outer) do...while      
  } // end main() 
  ...
  public static void determineSuitsAndValuesOfCards(int[] cards, 
                                     int[] suits, int[] values)
  {
